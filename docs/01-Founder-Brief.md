...
Forge Search Engine (FSE) is an evidence-first research platform.

Rather than simply generating answers, FSE investigates questions by gathering information from multiple trusted sources, evaluating the quality of the evidence, identifying consensus and disagreement, and presenting transparent, actionable research.
